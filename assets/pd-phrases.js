...
(function (global) {
  ...
  var ROWS = {
    ...
    'Lesson': ['Sambiro', 'Sifundvo', 'Isambililo', 'Phunziro'],
    'Lessons': ['Masambiro', 'Tifundvo', 'Amambililo', 'Maphunziro'],
    'Teaching': ['Kusambizga', 'Kufundzisa', 'Ukufunda', 'Kuphunzitsa'],
    'Study PDF': ['Sambiro la PDF', 'Sifundvo se PDF', 'Isambililo lya PDF', 'Phunziro la PDF'],
    'Audio': ['Mazgu', 'Livi', 'Ishiwi', 'Mawu'],
    'Take Quiz': ['Yamba Mafumbo', 'Calani Sivivinyo', 'Tampeni Ipusho', 'Yambani Mafunso'],
    'Page': ['Peji', 'Likhasi', 'Peji', 'Tsamba'],
    'Previous': ['Yamumbuyo', 'Emuva', 'Kunyuma', 'Kumbuyo'],
    'Next': ['Chakuronza', 'Olandzelako', 'Icaikonka', 'Chotsatira'],
    'Open Dedicated Lesson Page': ['Jalani Peji la Sambiro', 'Vulani Likhasi leSifundvo', 'Ijaleni Peji lya Isambililo', 'Tsegulani Tsamba la Phunziro'],
    'Start Quiz': ['Yambani Mafumbo', 'Calani Sivivinyo', 'Tampeni Ipusho', 'Yambani Mafunso'],
    'Professional Bible Games': ['Maseŵera gha Baibolo', 'Imidlalo yeBhayibheli', 'Inshindo sha Baibolo', 'Masewera a Baibulo'],
    'Scripture Memory': ['Kukumbukira Malemba', 'Kukhumbula ImiBhalo', 'Ukukumbukila Amalembelo', 'Kukumbukira Malemba'],
    'Bible Challenge': ['Mayesero gha Baibolo', 'Inselelo yeBhayibheli', 'Ukupimwa kwa Baibolo', 'Mayeso a Baibulo'],
    'Verse Scramble': ['Kupanga Malemba', 'Kuhlela Live', 'Ukupanga Amalembelo', 'Kusokoneza Vesi'],
    'Faith Journey': ['Ulendo wa Chipulikano', 'Luhambo Lwekukholwa', 'Ulendo wa Citetekelo', 'Ulendo wa Chikhulupiriro'],
    'Daily Streak': ['Mzere wa Zuŵa', 'Luchungecho Lwemalanga', 'Umusango wa Bushiku', 'Mzere wa Tsiku'],
    'Certificates': ['Zikalata', 'Tichetifiketi', 'Ifikalata', 'Satifiketi'],
    'Topic-only questions': ['Mafumbo gha mutu wose', 'Imibuto Yendzaba Kuphela', 'Ipusho lya Mutu Weka', 'Mafunso a Mutu Wokha'],
    'Prayer Wall': ['Khoma la Pemphero', 'Libondza Lemkhuleko', 'Cibumba ca Ipepo', 'Khoma la Pemphero'],
