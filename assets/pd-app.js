  ...
  var i18n = {
    ...
    t: function (key) {
      if (window.pdT) {
        ...
        'portal.bible': { en: 'Bible', tum: 'Baibolo', ssw: 'LiBhayibheli', bem: 'Baibolo', nya: 'Baibulo' },
        'portal.assistant': { en: 'Assistant', tum: 'Wovwiri', ssw: 'Umsiti', bem: 'Umwafwilisha', nya: 'Wothandiza' },
        'portal.sermons': { en: 'Sermons', tum: 'Maupharazgi', ssw: 'Tintshumayelo', bem: 'Icilengo', nya: 'Ulaliki' },
        'portal.teaching': { en: 'Teaching', tum: 'Masambiro', ssw: 'Kufundzisa', bem: 'Amasambilo', nya: 'Kuphunzitsa' },
        'portal.stories': { en: 'Stories', tum: 'Nkhani', ssw: 'Tindzaba', bem: 'Ifyano', nya: 'Nkhani' },
        'portal.resources': { en: 'Resources', tum: 'Vya Kukhwaska', ssw: 'Tinsita', bem: 'Ifyakubomfya', nya: 'Zothandizira' },
        'portal.translate': { en: 'Translate', tum: 'Sungunula', ssw: 'Humusha', bem: 'Alula', nya: 'Tanthauzirani' },
        'portal.gallery': { en: 'Gallery', tum: 'Vithuzi', ssw: 'Tithombe', bem: 'Ifikope', nya: 'Zithunzi' },
        'portal.give': { en: 'Give', tum: 'Pereka', ssw: 'Nikela', bem: 'Pela', nya: 'Perekani' },
        'portal.live': { en: 'Live', tum: 'Moyo', ssw: 'Bukhoma', bem: 'Ubumi', nya: 'Moyo' },
        'portal.quiz': { en: 'Quiz', tum: 'Mafumbo', ssw: 'Imibuto', bem: 'Amepusho', nya: 'Mafunso' },
        'portal.membership': { en: 'Membership', tum: 'Umbali', ssw: 'Bulunga', bem: 'Bumembala', nya: 'Umembala' },
        'portal.support': { en: 'Support', tum: 'Wovwiri', ssw: 'Sekela', bem: 'Wafwilisha', nya: 'Thandizo' },
        'portal.testimony': { en: 'Testimony', tum: 'Ukwititira', ssw: 'Bufakazi', bem: 'Ubwitness', nya: 'Umboni' },
        'portal.events': { en: 'Events', tum: 'Viphikiro', ssw: 'Imicimbi', bem: 'Ifilonganino', nya: 'Zochitika' },
        'portal.news': { en: 'News', tum: 'Nkhani', ssw: 'Tindzaba', bem: 'Ifyashi', nya: 'Nkhani' },
        'portal.media': { en: 'Media', tum: 'Vyakuwona', ssw: 'Imidiya', bem: 'Imediya', nya: 'Media' },
        'portal.about': { en: 'About', tum: 'Za ise', ssw: 'Ngatsi', bem: 'Palwa ifwe', nya: 'Za ife' },
        'portal.contact': { en: 'Contact', tum: 'Dumbiranani', ssw: 'Xhumana', bem: 'Tumeni', nya: 'Lumikizanani' },
        'portal.team': { en: 'Team', tum: 'Gulu', ssw: 'Licembu', bem: 'Ikipani', nya: 'Gulu' },
        'portal.chat': { en: 'Chat', tum: 'Kudumbiskana', ssw: 'Ingcoco', bem: 'Ukulanshana', nya: 'Kukambirana' },
